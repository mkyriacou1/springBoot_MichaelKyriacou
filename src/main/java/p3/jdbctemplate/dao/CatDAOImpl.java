...
public class CatDAOImpl implements CatDAO {
	...
	public Optional<Cat> findOne(Cat cats) {
		Optional<Cat> oCat = Optional.ofNullable(null);
		if (cats != null) {
			Long id = cats.getId();
			if (id != null) {
				...
				if (cats1 == null) {
					logger.info("findOne could not find a cat for name:{}, type:{}", name, type);
	...
	public void delete(Cat cats) {
		if (cats != null) {
			...
			if (id != null) {
				...
				Optional<Cat> oCat = findOne(cats);
